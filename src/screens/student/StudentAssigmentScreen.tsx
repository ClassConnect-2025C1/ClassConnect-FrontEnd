...
export default function StudentAssignmentScreen({ route }) {
  const { assignment, course, userId } = route.params;
  ...
  return (
    <View style={styles.mainContainer}>
      ...
      <View style={styles.headerContainer}>
        ...
        <Text style={styles.subtitle}>{description || 'No description available'}</Text>
        <Text style={styles.detail}>Due: {new Date(deadline).toLocaleDateString()}</Text>
      ...
      <ScrollView contentContainerStyle={styles.contentContainer}>
        <View style={styles.assignmentDetailContainer}>
          <Text style={styles.assignmentDetailText}>
            Detailed instructions for the assignment will go here...
          </Text>
        </View>
      </ScrollView>
